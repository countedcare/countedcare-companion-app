...
export const fetchShopifyProducts = async (first: number = 20): Promise<ShopifyProduct[]> => {
  console.log('Attempting to fetch products from:', 'apex-quality-resources.myshopify.com');
  ...
  try {
    ...
    console.error('1. Incorrect shop domain (currently: apex-quality-resources.myshopify.com)');
